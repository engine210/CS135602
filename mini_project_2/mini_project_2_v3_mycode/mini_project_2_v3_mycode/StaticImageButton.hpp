...
#ifndef StaticImageButton_hpp
#define StaticImageButton_hpp
...
namespace Engine {
    ...
    /// </summary>
    class StaticImageButton: public Image, public IControl {
    protected:
    ...
    public:
        ...
        explicit StaticImageButton(std::string img, std::string imgIn, float x, float y, float w = 0, float h = 0, float anchorX = 0, float anchorY = 0);
        /// <summary>
